                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-1 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className={getPriorityBadgeClass(entry.priority as WorkEntryPriority)}>
                          {entry.priority}
                        </Badge>
                        {getStatusBadge((entry as any).status as WorkEntryStatus)}
                      </div>
                    ...
                    <div className="flex items-center gap-1">
                      {/* Only show edit/delete for non-approved entries */}
