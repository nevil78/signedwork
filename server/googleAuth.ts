...
export function setupGoogleAuth() {
  ...
  passport.use('google-employee', new GoogleStrategy({
    ...
    callbackURL: process.env.NODE_ENV === 'production' ? 'https://www.signedwork.com/api/auth/google/callback' : `https://${process.env.REPLIT_DEV_DOMAIN}/api/auth/google/callback`,
    scope: ['profile', 'email']
