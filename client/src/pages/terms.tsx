    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mt-4" data-testid="heading-terms-title">
            Terms of Service
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          <div className="prose dark:prose-invert max-w-none">
            ...
            {/* Eligibility */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-eligibility">
                2. Eligibility
              </h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed" data-testid="text-eligibility">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-accounts">
                3. Accounts & Responsibilities
              </h2>
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-3" data-testid="text-accounts">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-verification">
                4. Employee Work Verification
              </h2>
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-3" data-testid="text-verification">
                <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-hiring">
                5. Job Applications & Hiring
              </h2>
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-3" data-testid="text-hiring">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-prohibited">
                6. Prohibited Activities
              </h2>
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed" data-testid="text-prohibited">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-ip">
                7. Intellectual Property
              </h2>
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-3" data-testid="text-ip">
                <p>
            ...
            {/* Termination */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-termination">
                8. Termination
              </h2>
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-3" data-testid="text-termination">
                <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-liability">
                9. Limitation of Liability
              </h2>
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-3" data-testid="text-liability">
                <p>
            ...
            {/* Changes to Terms */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-changes">
                10. Changes to Terms
              </h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed" data-testid="text-changes">
            ...
            {/* Contact */}
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" data-testid="heading-contact">
                11. Contact Us
              </h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed" data-testid="text-contact">
